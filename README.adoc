...
one to change.
- The factories and icons are CLJC, so you can more easily code things that will be used with SSR. NOTE: The clj
versions of the factories generate nil! The intention is for you to do SSR with something like Nashorn.
