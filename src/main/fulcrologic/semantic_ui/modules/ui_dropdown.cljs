(ns fulcrologic.semantic-ui.modules.ui-dropdown
  (:require
    [fulcrologic.semantic-ui.factory-helpers :as h]
    ["semantic-ui-react" :refer [Dropdown DropdownMenu DropdownItem DropdownSearchInput DropdownHeader DropdownDivider]]))
...
(def ui-dropdown-search-input
  ...
  Props:
   ...
   (h/factory-apply DropdownSearchInput))
